...
const efirPortals = [
  { name: "Vehicle Theft eFIR", description: "Electronic FIR for vehicle theft cases", url: "#" },
  { name: "Mobile Theft eFIR", description: "Electronic FIR for mobile phone theft", url: "#" }
];
