...
const atmTools = [
  { name: "RBI ATM Finder", description: "Reserve Bank of India ATM locator", url: "#" },
  { name: "Bank-specific ATM Locator", description: "Find ATMs by specific bank networks", url: "#" }
];
