...
const analysisTools = [
  { name: "FotoForensics", description: "Analyze photos for digital manipulation", url: "#" },
  { name: "Video Frame Grabber", description: "Extract frames from video files", url: "#" },
  { name: "Metadata Cleaner", description: "Remove metadata from images and videos", url: "#" }
];
