...
const mobileTools = [
  { name: "Truecaller Web", description: "Identify unknown phone numbers", url: "#" },
  { name: "Phone Validator", description: "Validate phone number format and carrier", url: "#" },
  { name: "SMS Backup Tool", description: "Backup and analyze SMS messages", url: "#" }
];
