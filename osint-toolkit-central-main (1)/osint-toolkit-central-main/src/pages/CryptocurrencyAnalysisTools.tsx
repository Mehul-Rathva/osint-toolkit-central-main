...
const cryptoTools = [
  { name: "Blockchain Explorer", description: "Explore blockchain transactions and addresses", url: "#" },
  { name: "Wallet Lookup Tool", description: "Look up wallet information and balance", url: "#" },
  { name: "Address Tag Checker", description: "Check if addresses are tagged or flagged", url: "#" },
  { name: "Transaction Tracer", description: "Trace cryptocurrency transactions", url: "#" }
];
