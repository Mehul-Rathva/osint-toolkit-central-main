...
const osintTools = [
  { name: "OSINT Framework Viewer", description: "Comprehensive OSINT tools framework", url: "#" },
  { name: "Censys Search Tool", description: "Internet-wide scanning and intelligence platform", url: "#" },
  { name: "Shodan.io Search", description: "Search engine for Internet-connected devices", url: "#" }
];
