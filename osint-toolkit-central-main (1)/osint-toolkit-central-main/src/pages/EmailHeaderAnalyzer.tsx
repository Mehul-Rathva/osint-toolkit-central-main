...
const emailTools = [
  { name: "MX Toolbox", description: "Analyze email headers and DNS records", url: "#" },
  { name: "Mail Header Analyzer Tool", description: "Detailed email header analysis", url: "#" }
];
      ...
      <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container flex h-14 items-center">
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className="font-bold text-foreground">Email Header Analyzer</span>
          </div>
        </div>
      </header>
        ...
        <div className="container mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Analyze email headers for investigation and verification of email authenticity.
            </p>
          </div>
