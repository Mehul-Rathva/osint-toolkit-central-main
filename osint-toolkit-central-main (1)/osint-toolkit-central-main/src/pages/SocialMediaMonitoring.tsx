...
const monitoringTools = [
  { name: "Mention Analyzer", description: "Track mentions across social media platforms", url: "#" },
  { name: "Twitter Advanced Search", description: "Advanced search tools for Twitter/X", url: "#" },
  { name: "Social Searcher Tool", description: "Search across multiple social networks", url: "#" }
];
