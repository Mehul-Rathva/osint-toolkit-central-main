...
const gpsTools = [
  { name: "GPS Upload Page", description: "Upload GPS data for visualization", url: "#" },
  { name: "GPS Visualization Map Output", description: "View GPS data on interactive maps", url: "#" }
];
