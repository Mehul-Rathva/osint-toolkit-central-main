...
const carTools = [
  { name: "Upload Photo", description: "Upload vehicle image for recognition", url: "#" },
  { name: "Detected Brand & Model Output", description: "View recognized vehicle information", url: "#" }
];
