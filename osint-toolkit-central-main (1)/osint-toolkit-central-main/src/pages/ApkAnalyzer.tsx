...
const apkTools = [
  { name: "Jadx Web", description: "Online APK decompiler and analyzer", url: "#" },
  { name: "APKTool Online", description: "Online APK analysis and reverse engineering", url: "#" }
];
      ...
      <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container flex h-14 items-center">
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className="font-bold text-foreground">APK Analyzer</span>
          </div>
        </div>
      </header>
        ...
        <div className="container mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Analyze Android application packages for security and forensic investigation.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {apkTools.map((tool, index) => (
