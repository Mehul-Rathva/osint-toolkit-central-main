...
const policePortals = [
  { name: "Login Page", description: "Access cyber police portal login", url: "https://www.cyberpolice.nic.in/" },
  { name: "FIR Filing Section", description: "File FIR through cyber police portal", url: "https://www.cyberpolice.nic.in/" }
];
