...
const ipLoggerTools = [
  { name: "IP Logger Website", description: "Create IP logging links", url: "https://iplogger.org/" },
  { name: "Logger Dashboard", description: "View and manage logged IP data", url: "https://iplogger.org/" }
];

const IpLoggerUtility = () => {
  return (
      ...
      <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container flex h-14 items-center">
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className="font-bold text-foreground">IP Logger Utility</span>
          </div>
        </div>
      </header>
        ...
        <div className="container mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Log and track IP addresses for investigation and security purposes.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {ipLoggerTools.map((tool, index) => (
...
export default IpLoggerUtility;
