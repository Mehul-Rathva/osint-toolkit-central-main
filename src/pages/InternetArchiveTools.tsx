...
const archiveTools = [
  { name: "Wayback Machine", description: "Browse archived web pages", url: "https://web.archive.org/" },
  { name: "Archive.is", description: "Create and browse archived snapshots", url: "https://archive.org/" }
];

const InternetArchiveTools = () => {
  return (
      ...
      <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container flex h-14 items-center">
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className="font-bold text-foreground">Internet Archive Tools</span>
          </div>
        </div>
      </header>
        ...
        <div className="container mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Access archived web content and historical snapshots of websites.
            </p>
          </div>
...
export default InternetArchiveTools;
