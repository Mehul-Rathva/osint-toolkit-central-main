...
const atmTools = [
  { name: "RBI ATM Finder", description: "Reserve Bank of India ATM locator", url: "https://www.npci.org.in/atm/locator" },
  { name: "Bank-specific ATM Locator", description: "Find ATMs by specific bank networks", url: "https://www.visa.com/locator/atm" }
];

const NationwideAtmLocator = () => {
  return (
      ...
      <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container flex h-14 items-center">
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className="font-bold text-foreground">Nationwide ATM Locator</span>
          </div>
        </div>
      </header>
        ...
        <div className="container mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Find ATMs across the country using official banking networks.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {atmTools.map((tool, index) => (
...
export default NationwideAtmLocator;
