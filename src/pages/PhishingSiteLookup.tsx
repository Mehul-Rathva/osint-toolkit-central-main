...
const phishingTools = [
  { name: "PhishTank", description: "Community-driven phishing site database", url: "https://phishtank.org/" },
  { name: "Google Safe Browsing", description: "Google's safe browsing checker", url: "https://safebrowsing.google.com/" }
];

const PhishingSiteLookup = () => {
  return (
        ...
        <div className="container mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Check websites for phishing attempts and security threats.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {phishingTools.map((tool, index) => (
...
export default PhishingSiteLookup;
